    ...
    <section className="relative w-full overflow-hidden bg-[#0A070D] min-h-105 sm:min-h-125 flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28 text-center flex flex-col items-center">
        ...
        <div className="inline-flex items-center px-4 sm:px-5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-6 sm:mb-8">
          <span className="text-[14px] sm:text-xs font-normal uppercase tracking-widest text-white">
            WHAT WE DO
          </span>
        </div>
        ...
        <p className="text-[15px] sm:text-base md:text-[14px] text-gray-200 font-normal leading-relaxed max-w-full mx-auto mb-8 sm:mb-10 px-2 tracking-tight">
        ...
        <Link
          href="#consultation"
          className="bg-brand-purple hover:bg-[#471237] text-white font-medium px-6 sm:px-8 py-3 sm:py-3.5 rounded-md text-sm sm:text-base inline-flex items-center justify-center transition-all duration-200 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-purple focus:ring-offset-2 focus:ring-offset-gray-900"
        >
          Book a Consultation
        </Link>
      </div>
